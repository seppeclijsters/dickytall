...
const webpack = {
  ...
  // gulp.src('src/assets/js/single_page/projects.js')
  // .pipe(named())
  // .pipe($.sourcemaps.init())
  ...
  // ))
  // .pipe(gulp.dest(PATHS.dist + '/assets/js/single_page'));

  build() {
    // return gulp.src('src/assets/js/overons.js')
    //   .pipe(named())
    ...
    //   .pipe(gulp.dest(PATHS.dist + '/assets/js'));
      ...
      gulp.src('src/assets/js/overons.js')
      .pipe(named())
      .pipe($.sourcemaps.init())
      .pipe(webpackStream(webpack.config, webpack2))
      .pipe($.if(PRODUCTION, $.uglify()
